...
TfLiteRegistration* Register_FLEXPOS_POSTPROCESS();
...
class MicroMutableOpResolver : public MicroOpResolver {
 public:
  ...
  TfLiteStatus AddDetectionPostprocess() {
   ...
   TfLiteStatus AddFlexposPostprocess() {
    return AddCustom("TFLite_FlexPos_PostProcess",
                     tflite::Register_FLEXPOS_POSTPROCESS());
  } 
  ...
  TfLiteStatus AddSlice() {
    return AddBuiltin(BuiltinOperator_SLICE,
                      ...
                      ParseTranspose /* reuse transpose */);
  }
